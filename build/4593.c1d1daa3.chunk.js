(self["webpackChunkminagrif_cms"] = self["webpackChunkminagrif_cms"] || []).push([[4593],{
...
var CKEditor_configs = __webpack_require__(57040);
// EXTERNAL MODULE: ./node_modules/@_sh/strapi-plugin-ckeditor/admin/src/utils/pluginId.js
var pluginId = __webpack_require__(66923);
...
const setLanguage = async (config) => {
  ...
  const preferedLanguage = helper_plugin_esm/* auth.getUserInfo */.I8.getUserInfo().preferedLanguage;
  ...
  if (overwrite) {
    ...
    if (userConfigs) {
      Object.keys(userConfigs).map((cfgName) => {
        if (CKEditor_configs/* default.hasOwnProperty */.Z.hasOwnProperty(cfgName)) {
...
const setPlugins = (config, { responsiveDimensions }, toggleMediaLib) => {
  ...
  if (configPluginNames.includes("StrapiUploadAdapter")) {
    config.editorConfig.strapiUploadAdapter = {
      ...
      headers: { Authorization: "Bearer " + helper_plugin_esm/* auth.getToken */.I8.getToken() },
...
const common = styled_components_browser_esm/* css */.iv`
  .ck {
...
const light = styled_components_browser_esm/* css */.iv`
  :root {
...
const dark = styled_components_browser_esm/* css */.iv`
  :root {
    --ck-color-focus-outer-shadow: rgba(77, 115, 255, 0.2) !important;
...
const additional = styled_components_browser_esm/* css */.iv`
...
const CounterLoaderBox = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  display:flex;
  width: 100%;
  justify-content: flex-end;
  align-items: center;
  `;
const LoaderBox = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  display:flex;
  height: 200px;
  width: 100%;
